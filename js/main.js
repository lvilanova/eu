(function($) {
    ...
    if ($('#instagram-widget').length != 0) {
        var instaFeedFooter = new Instafeed({
            ...
            template: '<div class="instagram-item"><li><a href="{{link}}" target="_blank" id="{{id}}"><img src="{{image}}" /></a></li></div>'
        });
        instaFeedFooter.run();
    }
...
//'<div class="portfolio-item-content"><div class="item-thumbnail"><img src="{{image}}" alt=""></div><div class="portfolio-description"><div class="action-btns"><a href="{{link}}" target="_blank" class="portfolio-gallery-set" id="{{id}}"><i class="ti-zoom-in"></i></a></div></div></div>'
})(jQuery);